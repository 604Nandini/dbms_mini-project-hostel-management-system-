...
<body>
	<style type="text/css">
		.sidenav .dropdown-container .dropdown-links a{
...
<?php } ?>
												<div class="col-sm-8 col-sm-offset-2">
													...
													<input class="btn btn-warning btn-lg" name="submit"  type="submit" value="Update" style="margin-left: 30%;width: 150px; border-radius: 20px; font-size: 20px; outline: none; background-color:  #F2B124; height: 50px; padding-top: 11px;">
												</div>
											</div>
