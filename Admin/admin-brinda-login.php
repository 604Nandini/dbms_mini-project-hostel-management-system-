...
<div class="brinda-container">
	...
	Manasa G B <br>
 <div class="id" style="">
<input class="email" type="text" name="username" value="brinda" readonly="readonly" style="display: none;">
</div> 
...
<button name="login">Login <i class="fa fa-angle-double-right fa-lg"></i></button>
</div>
</div>
