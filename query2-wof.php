	...
	<div class="ts-main-content" style="margin-left: -240px;">
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title "style="text-align: center;margin-left: 250px;margin-top: 50px; text-transform: capitalize; padding-bottom: 10px;">Students who did not opt for food but paid</h2>
...
<?php	
//$aid=$_SESSION['id'];
$ret="select distinct ur.regNo,ur.firstName,ur.middleName,ur.lastName,r.roomno,r.foodstatus,p.totalamount from userregistration ur, registration r,payment p where ur.regNo=r.regno and ur.firstName=r.firstName  and r.emailid=p.emailid and ur.regNo=p.regno and r.foodstatus=0; ";
...
<td><?php if($row->foodstatus==0) echo "Not Opted";?></td>
