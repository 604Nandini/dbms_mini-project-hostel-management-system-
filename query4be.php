...
<?php	
//$aid=$_SESSION['id'];
$ret="select r.regno,r.firstName,r.middleName,r.lastName,r.course,c.course_code,course_sn,course_fn from registration r,courses c where r.course=c.course_fn and r.course='Bachelor of Engineering';";
